	...
	return []featuredPostData{
		{
			...
			ImgModifier: "recommended recommended_first",
			Author:      "Mat Vogels",
		...
		},
		{
			...
			ImgModifier: "recommended recommended_second",
			Author:      "William Wong",
	...
	return []mostRecentPostData{
		{
			...
			Image:       "/static/img/parachutes.png",
			Author:      "William Wong",
			AuthorImg:   "/static/img/William_Wong.png",
		...
		},
		{
			...
			Image:       "/static/img/water_fall.png",
			Author:      "Mat Vogels",
			AuthorImg:   "/static/img/Mat_Vogels.png",
			PublishDate: "9/25/2015",
		},
		{
			...
			Image:       "/static/img/sea_breeze.png",
			Author:      "William Wong",
			AuthorImg:   "/static/img/William_Wong.png",
			PublishDate: "9/25/2015",
		},
		{
			...
			Image:       "/static/img/funicular.png",
			Author:      "Mat Vogels",
			AuthorImg:   "/static/img/Mat_Vogels.png",
			PublishDate: "9/25/2015",
		},
		{
			...
			Image:       "/static/img/man_and_waterfall.png",
			Author:      "Mat Vogels",
			AuthorImg:   "/static/img/Mat_Vogels.png",
			PublishDate: "9/25/2015",
		},
...
func postInfo() postInfoData {
	return postInfoData{
		Title:    "The Road Ahead",
		Subtitle: "The road ahead might be paved - it might not be.",
		Image:    "/static/img/northern_lights_picture.png",
